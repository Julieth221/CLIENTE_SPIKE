    ...
    this.apiService.get(`${API_URLS.CRUD.API_CRUD_FINCA}/Arrendamiento`)
      ...
      .subscribe({
        next: (arrendamientosResponse: any) => {
          ...
          console.log('Parcelas de la finca filtradas:', parcelasDeLaFinca);
          ...
          console.log('IDs de parcelas a consultar:', parcelasIds);
            ...
            .subscribe({
              next: (parcelasResponses: any) => {
                ...
                const parcelasPromises = parcelasResponses.map((parcelaResponse: any, index: any) => {
                  ...
                  console.log(`Datos de la parcela ${index + 1}:`, parcela);
                                ...
                                next: (geoResponse: any) => {
                                  if (!geoResponse || !geoResponse.Data) {
                                    resolve({
                                      ...
                                      tamano: parcela.TamañoParcela || 0,
                                      coordenadas: {
                                        latitudInicial: 0,
                                        longitudInicial: 0,
                                        latitudFinal: 0,
